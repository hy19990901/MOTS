...
```1.model_train``` : This folder contains the code related to model training.  The model training code of this work refers to [MCP](https://github.com/actionabletest/MCP). Please refer to their work if you need more information.
...
```3.run.py``` : This file guides the execution of NSGA-II.

```4.EA.py``` : This file describes the basic configuration and the structure of NSGA-II.

```5.objectives.py``` : This file defines two objectives in NSGA-II.

```6.retrain.py``` : This file describes the details for model retraining.
